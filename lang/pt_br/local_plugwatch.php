...
$string['messageprovider:new_plugins_digest'] = 'Resumo de novos plugins';
$string['messageprovider:plugin_updated'] = 'Atualização de plugin disponível';
$string['newplugins_digest_intro'] = '{$a} novos plugins foram publicados no Diretório de Plugins desde o seu último resumo:';
$string['newplugins_digest_subject'] = 'Resumo de novos plugins: {$a} novos plugins';
...
$string['notifynewplugins'] = 'Notificar sobre novos plugins publicados';
$string['notifynewplugins_help'] = 'Envia um e-mail resumo consolidado listando novos plugins publicados no Diretório de Plugins, na frequência configurada acima.';
...
$string['privacy:metadata:preference:local_plugwatch_frequency'] = 'A frequência de notificação (diária, semanal ou mensal) escolhida pelo usuário.';
$string['privacy:metadata:preference:local_plugwatch_lastdigest'] = 'O timestamp do último resumo de novos plugins enviado a este usuário.';
$string['privacy:metadata:preference:local_plugwatch_notifynewplugins'] = 'Se o usuário optou por receber o resumo de novos plugins.';
