...
$string['messageprovider:new_plugins_digest'] = 'New plugins digest';
$string['messageprovider:plugin_updated'] = 'Plugin update available';
$string['newplugins_digest_intro'] = '{$a} new plugins were published in the Plugin Directory since your last digest:';
$string['newplugins_digest_subject'] = 'New plugins digest: {$a} new plugins';
...
$string['notifynewplugins'] = 'Notify me about new plugins published';
$string['notifynewplugins_help'] = 'Sends a consolidated digest e-mail listing new plugins published in the Plugin Directory, at the frequency configured above.';
...
$string['privacy:metadata:preference:local_plugwatch_frequency'] = 'The notification frequency (daily, weekly or monthly) chosen by the user.';
$string['privacy:metadata:preference:local_plugwatch_lastdigest'] = 'The timestamp of the last new-plugins digest sent to this user.';
$string['privacy:metadata:preference:local_plugwatch_notifynewplugins'] = 'Whether the user opted in to receive the new-plugins digest.';
